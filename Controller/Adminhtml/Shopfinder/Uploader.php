...

{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'shops/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'shops/' . $firstName . '/' . $secondName . '/';
            ...
            $imageResult['name'] = $firstName . '/' . $secondName . '/' . $newImageName;
            $imageResult['file'] = $newImageName;
            $imageResult['url'] = $mediaUrl . 'shops/' . $firstName . '/' . $secondName . '/' . $newImageName;
        } catch (\Exception $e) {
